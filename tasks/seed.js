...
const main = async () => {
    ...
    const S5 = await students.addStudents("Dan", "Su", "dan@stevens.edu", "$2y$16$KIjnyLrJ02Kpp6Y6HLZ6C.BDZidhOY73JYc4utfKCJB48Ithhr1oK");
    ...
    const S8 = await students.addStudents("Jessica", "Doe", "jessica@stevens.edu", "$2y$16$nEHCMDVuRC52/1j2AXfsyu5zsh3btEm0a3uvq.35kpEYR/pnFfS2a");
    ...
    const S10 = await students.addStudents("Ava", "Smith", "ava@stevens.edu", "$2y$16$E0t0gNTnCXbW.nvDjnQSZ.yUN0cjdv4sHIWHciyu45N4BEdamdBzu");
