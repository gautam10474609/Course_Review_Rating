...
const main = async () => {
    ...
    //Seed Sample courses
    const R1 = await courses.addcourse("Papa Johns", "papajohns.com", "Pizza", "125 18th Street", "Jersey City", "NJ", "07310", 40.732628, -74.037628);
    const R2 = await courses.addcourse("Chef Of India", "chefofindia.com", "Indian", "324 Central Ave", "Jersey City", "NJ", "07307", 40.7459498, -74.0512955);
    const R3 = await courses.addcourse("Vibez Juice & Vegan Cafe", "chefofindia.com", "Juice", "82 Hutton St", "Jersey City", "NJ", "07307", 40.7445109, -74.0514578);
    const R4 = await courses.addcourse("El Gordo", "elgordoeats.com", "Peruvian", "291 Central Ave", "Jersey City", "NJ", "07310", 40.7450379, -74.0524309);
    const R5 = await courses.addcourse("The Franklin", "thefranklinjc.com", "Italian", "159 New York Ave", "Jersey City", "NJ", "07310", 40.7417174, -74.0491971);
    const R6 = await courses.addcourse("Dino & Harry's Steakhouse", "dinoandharrys.com", "Steak", "163 14th St", "Hoboken", "NJ", "07030", 40.7534212, -74.0299569);
    const R7 = await courses.addcourse("La Isla", "laislacourse.com", "Cuban", "104 Washington St", "Hoboken", "NJ", "07310", 40.7228179, -74.1316417, "");
    const R8 = await courses.addcourse("Ali Baba course", "hobokenalibaba.com", "Middle Eastern", "912 Washington St Ste 1", "Hoboken", "NJ", "07310", 40.7477496, -74.0302254);
    const R9 = await courses.addcourse("South Street Fish & Ramen Co.", "southstreet.co", "Japanese", "219 Washington St", "Hoboken", "NJ", "07310", 40.7393196, -74.032313);
    const R10 = await courses.addcourse("GreekTown", "greektown-hoboken.com", "Greek", "86 Garden St", "Hoboken", "NJ", "07310", 40.7369868, -74.3132926);
    
    const R11 = await courses.addcourse("Cucharamama", "http://places.singleplatform.com/cucharamama/menu?ref=google", "Latin", "233 Clinton St", "Hoboken", "NJ", "07030", 40.7406889, -74.0368137);
    const R12 = await courses.addcourse("Zacks", "zackshoboken.com", "Latin", "232 Willow Ave", "Hoboken", "NJ", "07030", 40.7405781, -74.0361511);
    const R13 = await courses.addcourse("The Cuban", "thecubannj.com", "Cuban", "333 Washington St", "Hoboken", "NJ", "07030", 40.741024, -74.0317947);
    const R14 = await courses.addcourse("Amandas", "amandascourse.com", "American", "908 Washington St A", "Hoboken", "NJ", "07030", 40.7476503, -74.0303058);
    const R15 = await courses.addcourse("Augustinos", "www.google.com", "Italian", "1104 Washington St", "Hoboken", "NJ", "07030", 40.7502738, -74.029437);
    const R16 = await courses.addcourse("Barbès", "http://places.singleplatform.com/barbs-69/menu?ref=google", "French", "1300 Park Ave", "Hoboken", "NJ", "07030", 40.7529884, -74.0314436);
    const R17 = await courses.addcourse("Anthony Davids", "anthonydavids.com", "Italian", "953 Bloomfield St", "Hoboken", "NJ", "07030", 40.7485811, -74.0303674);
    const R18 = await courses.addcourse("Halifax", "halifaxhoboken.com", "American", "At W Hotel, 225 River St", "Hoboken", "NJ", "07030", 40.8132911, -74.1449544);
    const R19 = await courses.addcourse("Court Street", "courtstreet.com", "Continental", "61 Sixth St", "Hoboken", "NJ", "07030", 40.7431676, -74.0308204);
    const R20 = await courses.addcourse("Carpe Diem", "carpediemhoboken.com", "Irish", "333 Washington St", "Hoboken", "NJ", "07030", 40.8132911, -74.1449544);

    const R21 = await courses.addcourse("Elysian cafe", "elysiancafe.com", "French", "1001 Washington St", "Hoboken", "NJ", "07030", 40.7431672, -74.0373865);
    const R22 = await courses.addcourse("La Casa", "zhttp://places.singleplatform.com/la-casa-257/menu?ref=google", "Latin", "54 Newark St", "Hoboken", "NJ", "07030", 40.7369205, -74.0324397);
    const R23 = await courses.addcourse("Robongi Hoboken", "robonginj.com", "Japanese", "520 Washington St", "Hoboken", "NJ", "07030", 40.7429258, -74.0316348);
    const R24 = await courses.addcourse("Blue Eyes course", "blueeyescourse.com", "American", "525 Sinatra Dr", "Hoboken", "NJ", "07030", 40.7415968, -74.0283558);
    const R25 = await courses.addcourse("Union Hall Hoboken", "unionhallhoboken.com", "American", "306 Sinatra Dr", "Hoboken", "NJ", "07030", 40.7396827, -74.0293775);
    const R26 = await courses.addcourse("Sushi Lounge", "https://eat.chownow.com/discover/course/2717", "French", "200 Hudson St", "Hoboken", "NJ", "07030", 40.7386556, -74.0318276);
    const R27 = await courses.addcourse("Gogi Grill", "gogigrill.com", "Korean", "79 Hudson St", "Hoboken", "NJ", "07030", 40.7363549, -74.031882);
    const R28 = await courses.addcourse("Tony Boloney's Hoboken", "tonyboloneys.com", "Pizza", "263 1st St", "Hoboken", "NJ", "07030", 40.7379855, -74.0365272);
    const R29 = await courses.addcourse("Grimaldi's Pizzeria", "courtstreet.com", "Pizza", "411 Washington St", "Hoboken", "NJ", "07030", 40.7417167, -74.0316415);
    const R30 = await courses.addcourse("Karma Kafe", "https://direct.chownow.com/order/4287/locations/5566", "Indian", "505 Washington St", "Hoboken", "NJ", "07030", 40.742402, -74.0313777);

    //Seed Sample Studentss
    const U1 = await students.addStudents("Anna", "Brown", "anna@gmail.com", "", "Jersey City", "NJ", "21", "$2a$16$55b4ftaRCsHZcJ2X3VAmL.X85wi/K3ydOMWRoyafn2ubiA38l4HnK");
    const U2 = await students.addStudents("Anshul", "Kapoor", "anshul@gmail.com", "", "Jersey City", "NJ", "25", "$2y$16$44T/HRDYr7ZJr5NgxKZ0GO5VUWIO7eEzeh.SQauQqfsUhjLLm8XBq");
    const U3 = await students.addStudents("Kamil", "Zambrowski", "kamil@gmail.com", "", "Jersey City", "NJ", "22", "$2y$16$hJSJuDrg9GRus/zD3mfg..OhlFSEM1VFeOi4cxJhxKhHHmpPZRnjW");
    const U4 = await students.addStudents("Michael", "Lyons", "michael@gmail.com", "", "Jersey City", "NJ", "22", "$2y$16$yRArTdcisBcd6ED5FEWJuO/Z.LMWsUbHz52FotTzYtf86Kc4QKE6a");
    const U5 = await students.addStudents("John", "Doe", "john@gmail.com", "", "Jersey City", "NJ", "22", "$2y$16$KIjnyLrJ02Kpp6Y6HLZ6C.BDZidhOY73JYc4utfKCJB48Ithhr1oK");
    const U6 = await students.addStudents("Ava", "Tartaglia", "ava@gmail.com", "", "Hoboken", "NJ", "23", "$2y$16$ZvmyAhGKEXDIe1gDejC38.K7xWYnF2SzYhlr4GTuv6cNFmqbtH2k6");
    const U7 = await students.addStudents("Dan", "Pelis", "dan@gmail.com", "", "Hoboken", "NJ", "24", "$2y$16$dm4xV.Gvptu2Xl3Kh/S/suk8OoUoKZXUkqKExk8WD3ZUZXxd4QeK.");
    const U8 = await students.addStudents("Jessica", "Su", "jessica@gmail.com", "", "Hoboken", "NJ", "25", "$2y$16$nEHCMDVuRC52/1j2AXfsyu5zsh3btEm0a3uvq.35kpEYR/pnFfS2a");
    const U9 = await students.addStudents("Miles", "Rosenberg", "miles@gmail.com", "", "Hoboken", "NJ", "28", "$2y$16$IlU5ezmEuCip.KMmemBi7ePqMtT9JKkzZXhH05ILe7tqeKZemFn.m");
    const U10 = await students.addStudents("Joe", "Smith", "joe@gmail.com", "", "Hoboken", "NJ", "26", "$2y$16$E0t0gNTnCXbW.nvDjnQSZ.yUN0cjdv4sHIWHciyu45N4BEdamdBzu");
